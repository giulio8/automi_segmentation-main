...
class SeResUNet(nn.Module):
    def __init__(self, n_channels, n_classes, dropout=False, rate=0.1, last_layer_fusion=False):
        super(SeResUNet, self).__init__()
        self.name = "SE-ResUnet"
        self.n_classes = n_classes
        self.n_channels = n_channels
        self.last_layer_fusion = last_layer_fusion
    ...
    def forward(self, x):
        ...
        x11 = self.up4(x22, x1)
        x0 = self.outc(x11)
        return x0 if not self.last_layer_fusion else x11
