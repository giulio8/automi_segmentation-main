''' This script is dedicated to organise the dataset provided by City of Hope in a way to better read and be used by the machine learning
pipeline.'''
...
if __name__ == "__main__":
    ...
    datapath = datapaths.datapaths['CityOfHope']
    originalImgpath = datapaths.original_datasets['CityOfHope']
    ...
    for patient in os.listdir(originalImgpath):
        ...
        utils_data.moveRenameAllDicom(originalPatientPath, patientPath, False)
